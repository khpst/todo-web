...
export const TodoCard = ({
  ...
  return (
    <div
      className={`${getBgColor()} backdrop-blur-md bg-opacity-90 rounded-lg p-4 shadow-lg hover:shadow-xl transition-shadow duration-300 flex justify-between items-center border border-opacity-20`}
    >
      <div>
      ...
      <div className="flex items-center gap-3">
        ...
        <input
          ...
          className="w-6 h-6 rounded-full appearance-none border-2 bg-white border-gray-300 checked:border-blue-500 checked:bg-blue-500 relative after:content-['✓'] after:absolute after:text-white after:top-1/2 after:left-1/2 after:-translate-x-1/2 after:-translate-y-1/2 after:opacity-0 checked:after:opacity-100 transition-all duration-200 cursor-pointer"
